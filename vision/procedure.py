...
class VisionProcedure():
    ...
    def __init__(self, program_directory: str, name: str, input_iconic_variables: list, output_iconic_variables: list, 
        ...
        """
        Initialize the VisionProcedure with given input/output variables and types.

        :param program_directory: The directory containing the procedure
        :param name: The name of the procedure
        :param input_iconic_variables: List of iconic input variable names
        :param output_iconic_variables: List of iconic output variable names
        :param input_control_variables: List of control input variable names
        :param input_control_types: List of control input types
        :param output_control_variables: List of control output variable names
        :param output_control_types: List of control output types
        """
